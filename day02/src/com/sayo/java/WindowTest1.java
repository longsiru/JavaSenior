 ...
 * 存在线程安全问题，待解决。
 * 1.问题：买票的过程中，出现了重票和错票-->线程安全问题。
 * 2.问题出现的原因：当某个线程操作卖票的过程中，尚未操作完成时，其他线程参与进来，也操作车票。
 ...
 *                       2.共享数据:多个线程共同操作的变量，比如现在我们在练习的ticket。
...
class Window1 implements Runnable{
    ...
    public void run() {
        while(true){
            synchronized(this) {//方式一：首先this是个对象，叫当前对象。此时的this是唯一的Window1的对象。//方式二：synchronized(obj) {
                if (ticket > 0) {
